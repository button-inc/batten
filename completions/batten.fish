...
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "check" -d 'Run the applicable read-only gates against the repository'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "enforce" -d 'Run every configured rule, including kinds that execute a configured command'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "exec" -d 'Run a command, passing its streams and its exit code through unchanged'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "config" -d 'Inspect configuration'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "spec" -d 'Print the tool\'s own command spec'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "doctor" -d 'Diagnose whether Batten can run in this repository'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "generate" -d 'Emit artifacts derived from the command spec, on stdout'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "policy" -d 'Inspect the thresholds and path sets this repository holds itself to'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "hook" -d 'Adjudicate a mediated tool call read from stdin (a deny is exit 2, the one contract)'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "receipt" -d 'Verification receipts: SHA-keyed claims a named check passed, invalidated by git facts'
complete -c batten -n "__fish_batten_using_subcommand help; and not __fish_seen_subcommand_from check enforce exec config spec doctor generate policy hook receipt help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
