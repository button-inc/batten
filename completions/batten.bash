_batten() {
    ...
    do
        case "${cmd},${i}" in
            ...
            batten,check)
                ...
                ;;
            batten,checks)
                cmd="batten__subcmd__checks"
                ;;
            batten,ci)
                cmd="batten__subcmd__ci"
                ;;
            batten,claim)
            ...
            batten,help)
                ...
                ;;
            batten,hk)
                cmd="batten__subcmd__hk"
                ;;
            batten,init)
                cmd="batten__subcmd__init"
                ;;
            batten,land)
                cmd="batten__subcmd__land"
                ;;
            batten,landed)
                cmd="batten__subcmd__landed"
                ;;
            batten,lease)
                cmd="batten__subcmd__lease"
                ;;
            batten,lint)
                cmd="batten__subcmd__lint"
                ;;
            batten,mcp)
                cmd="batten__subcmd__mcp"
                ;;
            batten,mutate)
                cmd="batten__subcmd__mutate"
                ;;
            batten,override)
            ...
            batten,semver)
                ...
                ;;
            batten,show)
                cmd="batten__subcmd__show"
                ;;
            batten,singleton)
                cmd="batten__subcmd__singleton"
                ;;
            batten,spec)
                cmd="batten__subcmd__spec"
                ;;
            batten,startup)
                cmd="batten__subcmd__startup"
                ;;
            batten,state)
            ...
            batten__subcmd__attribution__subcmd__help,tagger)
                ...
                ;;
            batten__subcmd__bench,help)
                cmd="batten__subcmd__bench__subcmd__help"
                ;;
            batten__subcmd__bench,tokens)
                cmd="batten__subcmd__bench__subcmd__tokens"
                ;;
            batten__subcmd__bench__subcmd__help,help)
                cmd="batten__subcmd__bench__subcmd__help__subcmd__help"
                ;;
            ...
            batten__subcmd__checks,green)
                ...
                ;;
            batten__subcmd__checks,help)
                cmd="batten__subcmd__checks__subcmd__help"
                ;;
            batten__subcmd__checks__subcmd__help,green)
                cmd="batten__subcmd__checks__subcmd__help__subcmd__green"
                ;;
            batten__subcmd__checks__subcmd__help,help)
                cmd="batten__subcmd__checks__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__ci,help)
                cmd="batten__subcmd__ci__subcmd__help"
                ;;
            ...
            batten__subcmd__claim,bot)
                ...
                ;;
            batten__subcmd__claim,carry)
                cmd="batten__subcmd__claim__subcmd__carry"
                ;;
            ...
            batten__subcmd__claim,help)
                ...
                ;;
            batten__subcmd__claim,keys)
                cmd="batten__subcmd__claim__subcmd__keys"
                ;;
            batten__subcmd__claim,merged)
                cmd="batten__subcmd__claim__subcmd__merged"
                ;;
            batten__subcmd__claim,race)
                cmd="batten__subcmd__claim__subcmd__race"
                ;;
            batten__subcmd__claim__subcmd__help,bot)
                cmd="batten__subcmd__claim__subcmd__help__subcmd__bot"
                ;;
            batten__subcmd__claim__subcmd__help,carry)
                cmd="batten__subcmd__claim__subcmd__help__subcmd__carry"
                ;;
            ...
            batten__subcmd__claim__subcmd__help,help)
                ...
                ;;
            batten__subcmd__claim__subcmd__help,keys)
                cmd="batten__subcmd__claim__subcmd__help__subcmd__keys"
                ;;
            batten__subcmd__claim__subcmd__help,merged)
                cmd="batten__subcmd__claim__subcmd__help__subcmd__merged"
                ;;
            batten__subcmd__claim__subcmd__help,race)
                cmd="batten__subcmd__claim__subcmd__help__subcmd__race"
                ;;
            ...
            batten__subcmd__doctor,session)
                ...
                ;;
            batten__subcmd__doctor,target)
                cmd="batten__subcmd__doctor__subcmd__target"
                ;;
            ...
            batten__subcmd__doctor__subcmd__help,session)
                ...
                ;;
            batten__subcmd__doctor__subcmd__help,target)
                cmd="batten__subcmd__doctor__subcmd__help__subcmd__target"
                ;;
            ...
            batten__subcmd__help,check)
                ...
                ;;
            batten__subcmd__help,checks)
                cmd="batten__subcmd__help__subcmd__checks"
                ;;
            batten__subcmd__help,ci)
                cmd="batten__subcmd__help__subcmd__ci"
                ;;
            ...
            batten__subcmd__help,help)
                ...
                ;;
            batten__subcmd__help,hk)
                cmd="batten__subcmd__help__subcmd__hk"
                ;;
            batten__subcmd__help,init)
                cmd="batten__subcmd__help__subcmd__init"
                ;;
            batten__subcmd__help,land)
                cmd="batten__subcmd__help__subcmd__land"
                ;;
            batten__subcmd__help,landed)
                cmd="batten__subcmd__help__subcmd__landed"
                ;;
            batten__subcmd__help,lease)
                cmd="batten__subcmd__help__subcmd__lease"
                ;;
            batten__subcmd__help,lint)
                cmd="batten__subcmd__help__subcmd__lint"
                ;;
            batten__subcmd__help,mcp)
                cmd="batten__subcmd__help__subcmd__mcp"
                ;;
            batten__subcmd__help,mutate)
                cmd="batten__subcmd__help__subcmd__mutate"
                ;;
            ...
            batten__subcmd__help,policy)
                ...
                ;;
            batten__subcmd__help,pr)
                cmd="batten__subcmd__help__subcmd__pr"
                ;;
            ...
            batten__subcmd__help,receipt)
                ...
                ;;
            batten__subcmd__help,record)
                cmd="batten__subcmd__help__subcmd__record"
                ;;
            ...
            batten__subcmd__help,semver)
                ...
                ;;
            batten__subcmd__help,show)
                cmd="batten__subcmd__help__subcmd__show"
                ;;
            batten__subcmd__help,singleton)
                cmd="batten__subcmd__help__subcmd__singleton"
                ;;
            batten__subcmd__help,spec)
                cmd="batten__subcmd__help__subcmd__spec"
                ;;
            batten__subcmd__help,startup)
                cmd="batten__subcmd__help__subcmd__startup"
                ;;
            ...
            batten__subcmd__help,verdict)
                ...
                ;;
            batten__subcmd__help,wiring)
                cmd="batten__subcmd__help__subcmd__wiring"
                ;;
            ...
            batten__subcmd__help__subcmd__claim,bot)
                ...
                ;;
            batten__subcmd__help__subcmd__claim,carry)
                cmd="batten__subcmd__help__subcmd__claim__subcmd__carry"
                ;;
            batten__subcmd__help__subcmd__claim,check)
                cmd="batten__subcmd__help__subcmd__claim__subcmd__check"
                ;;
            batten__subcmd__help__subcmd__claim,keys)
                cmd="batten__subcmd__help__subcmd__claim__subcmd__keys"
                ;;
            batten__subcmd__help__subcmd__claim,merged)
                cmd="batten__subcmd__help__subcmd__claim__subcmd__merged"
                ;;
            batten__subcmd__help__subcmd__claim,race)
                cmd="batten__subcmd__help__subcmd__claim__subcmd__race"
                ;;
            ...
            batten__subcmd__help__subcmd__doctor,session)
                ...
                ;;
            batten__subcmd__help__subcmd__doctor,target)
                cmd="batten__subcmd__help__subcmd__doctor__subcmd__target"
                ;;
            ...
            batten__subcmd__help__subcmd__generate,schema)
                ...
                ;;
            batten__subcmd__help__subcmd__hk,contract)
                cmd="batten__subcmd__help__subcmd__hk__subcmd__contract"
                ;;
            batten__subcmd__help__subcmd__hk,drift)
                cmd="batten__subcmd__help__subcmd__hk__subcmd__drift"
                ;;
            batten__subcmd__help__subcmd__hk,observe)
                cmd="batten__subcmd__help__subcmd__hk__subcmd__observe"
                ;;
            batten__subcmd__help__subcmd__land,fast-forward)
                cmd="batten__subcmd__help__subcmd__land__subcmd__fast__subcmd__forward"
                ;;
            ...
            batten__subcmd__help__subcmd__land,replay)
                ...
                ;;
            batten__subcmd__help__subcmd__land,verify)
                cmd="batten__subcmd__help__subcmd__land__subcmd__verify"
                ;;
            ...
            batten__subcmd__help__subcmd__lease,authorises)
                ...
                ;;
            batten__subcmd__help__subcmd__lease,carries)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__carries"
                ;;
            batten__subcmd__help__subcmd__lease,check)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__check"
                ;;
            batten__subcmd__help__subcmd__lease,guard)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__guard"
                ;;
            batten__subcmd__help__subcmd__lease,held)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__held"
                ;;
            batten__subcmd__help__subcmd__lease,hold)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__hold"
                ;;
            batten__subcmd__help__subcmd__lease,peek)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__peek"
                ;;
            batten__subcmd__help__subcmd__lease,release)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__release"
                ;;
            batten__subcmd__help__subcmd__lease,renew)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__renew"
                ;;
            batten__subcmd__help__subcmd__lease,reserve)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__reserve"
                ;;
            batten__subcmd__help__subcmd__lease,status)
                cmd="batten__subcmd__help__subcmd__lease__subcmd__status"
                ;;
            ...
            batten__subcmd__help__subcmd__mcp,spawn)
                ...
                ;;
            batten__subcmd__help__subcmd__mutate,census)
                cmd="batten__subcmd__help__subcmd__mutate__subcmd__census"
                ;;
            batten__subcmd__help__subcmd__mutate,sweep)
                cmd="batten__subcmd__help__subcmd__mutate__subcmd__sweep"
                ;;
            ...
            batten__subcmd__help__subcmd__payload,field)
                ...
                ;;
            batten__subcmd__help__subcmd__perf,compare)
                cmd="batten__subcmd__help__subcmd__perf__subcmd__compare"
                ;;
            ...
            batten__subcmd__help__subcmd__perf,pair)
                ...
                ;;
            batten__subcmd__help__subcmd__perf,record)
                cmd="batten__subcmd__help__subcmd__perf__subcmd__record"
                ;;
            ...
            batten__subcmd__help__subcmd__policy,explain)
                ...
                ;;
            batten__subcmd__help__subcmd__policy,hooks)
                cmd="batten__subcmd__help__subcmd__policy__subcmd__hooks"
                ;;
            batten__subcmd__help__subcmd__policy,rule)
                cmd="batten__subcmd__help__subcmd__policy__subcmd__rule"
                ;;
            ...
            batten__subcmd__help__subcmd__policy,tools)
                ...
                ;;
            batten__subcmd__help__subcmd__pr,closes)
                cmd="batten__subcmd__help__subcmd__pr__subcmd__closes"
                ;;
            batten__subcmd__help__subcmd__pr,derive)
                cmd="batten__subcmd__help__subcmd__pr__subcmd__derive"
                ;;
            batten__subcmd__help__subcmd__pr,ensure)
                cmd="batten__subcmd__help__subcmd__pr__subcmd__ensure"
                ;;
            batten__subcmd__help__subcmd__pr,file)
                cmd="batten__subcmd__help__subcmd__pr__subcmd__file"
                ;;
            ...
            batten__subcmd__help__subcmd__ready,lint)
                ...
                ;;
            batten__subcmd__help__subcmd__receipt,clean)
                cmd="batten__subcmd__help__subcmd__receipt__subcmd__clean"
                ;;
            ...
            batten__subcmd__help__subcmd__record,fold)
                ...
                ;;
            batten__subcmd__help__subcmd__record,forge)
                cmd="batten__subcmd__help__subcmd__record__subcmd__forge"
                ;;
            batten__subcmd__help__subcmd__record,journal)
                cmd="batten__subcmd__help__subcmd__record__subcmd__journal"
                ;;
            batten__subcmd__help__subcmd__record,keyed)
                cmd="batten__subcmd__help__subcmd__record__subcmd__keyed"
                ;;
            ...
            batten__subcmd__help__subcmd__record,show)
                ...
                ;;
            batten__subcmd__help__subcmd__record,suites)
                cmd="batten__subcmd__help__subcmd__record__subcmd__suites"
                ;;
            ...
            batten__subcmd__help__subcmd__target,prune)
                ...
                ;;
            batten__subcmd__help__subcmd__task,alive)
                cmd="batten__subcmd__help__subcmd__task__subcmd__alive"
                ;;
            batten__subcmd__help__subcmd__task,phase)
                cmd="batten__subcmd__help__subcmd__task__subcmd__phase"
                ;;
            batten__subcmd__help__subcmd__task,read)
                cmd="batten__subcmd__help__subcmd__task__subcmd__read"
                ;;
            batten__subcmd__help__subcmd__task,register)
                cmd="batten__subcmd__help__subcmd__task__subcmd__register"
                ;;
            batten__subcmd__help__subcmd__task,sig)
                cmd="batten__subcmd__help__subcmd__task__subcmd__sig"
                ;;
            batten__subcmd__help__subcmd__task,tick)
                cmd="batten__subcmd__help__subcmd__task__subcmd__tick"
                ;;
            ...
            batten__subcmd__help__subcmd__worktree,status)
                ...
                ;;
            batten__subcmd__hk,contract)
                cmd="batten__subcmd__hk__subcmd__contract"
                ;;
            batten__subcmd__hk,drift)
                cmd="batten__subcmd__hk__subcmd__drift"
                ;;
            batten__subcmd__hk,help)
                cmd="batten__subcmd__hk__subcmd__help"
                ;;
            batten__subcmd__hk,observe)
                cmd="batten__subcmd__hk__subcmd__observe"
                ;;
            batten__subcmd__hk__subcmd__help,contract)
                cmd="batten__subcmd__hk__subcmd__help__subcmd__contract"
                ;;
            batten__subcmd__hk__subcmd__help,drift)
                cmd="batten__subcmd__hk__subcmd__help__subcmd__drift"
                ;;
            batten__subcmd__hk__subcmd__help,help)
                cmd="batten__subcmd__hk__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__hk__subcmd__help,observe)
                cmd="batten__subcmd__hk__subcmd__help__subcmd__observe"
                ;;
            batten__subcmd__land,fast-forward)
                cmd="batten__subcmd__land__subcmd__fast__subcmd__forward"
                ;;
            batten__subcmd__land,help)
                cmd="batten__subcmd__land__subcmd__help"
                ;;
            ...
            batten__subcmd__land,replay)
                ...
                ;;
            batten__subcmd__land,verify)
                cmd="batten__subcmd__land__subcmd__verify"
                ;;
            batten__subcmd__land,wait)
                cmd="batten__subcmd__land__subcmd__wait"
                ;;
            batten__subcmd__land__subcmd__help,fast-forward)
                cmd="batten__subcmd__land__subcmd__help__subcmd__fast__subcmd__forward"
                ;;
            ...
            batten__subcmd__land__subcmd__help,replay)
                ...
                ;;
            batten__subcmd__land__subcmd__help,verify)
                cmd="batten__subcmd__land__subcmd__help__subcmd__verify"
                ;;
            ...
            batten__subcmd__landed__subcmd__help,check)
                ...
                ;;
            batten__subcmd__landed__subcmd__help,help)
                cmd="batten__subcmd__landed__subcmd__help__subcmd__help"
                ;;
            ...
            batten__subcmd__lease,authorises)
                ...
                ;;
            batten__subcmd__lease,carries)
                cmd="batten__subcmd__lease__subcmd__carries"
                ;;
            batten__subcmd__lease,check)
                cmd="batten__subcmd__lease__subcmd__check"
                ;;
            batten__subcmd__lease,guard)
                cmd="batten__subcmd__lease__subcmd__guard"
                ;;
            batten__subcmd__lease,held)
                cmd="batten__subcmd__lease__subcmd__held"
                ;;
            batten__subcmd__lease,help)
                cmd="batten__subcmd__lease__subcmd__help"
                ;;
            batten__subcmd__lease,hold)
                cmd="batten__subcmd__lease__subcmd__hold"
                ;;
            batten__subcmd__lease,peek)
                cmd="batten__subcmd__lease__subcmd__peek"
                ;;
            batten__subcmd__lease,release)
                cmd="batten__subcmd__lease__subcmd__release"
                ;;
            batten__subcmd__lease,renew)
                cmd="batten__subcmd__lease__subcmd__renew"
                ;;
            batten__subcmd__lease,reserve)
                cmd="batten__subcmd__lease__subcmd__reserve"
                ;;
            batten__subcmd__lease,status)
                cmd="batten__subcmd__lease__subcmd__status"
                ;;
            batten__subcmd__lease__subcmd__help,acquire)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__acquire"
                ;;
            batten__subcmd__lease__subcmd__help,authorises)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__authorises"
                ;;
            batten__subcmd__lease__subcmd__help,carries)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__carries"
                ;;
            batten__subcmd__lease__subcmd__help,check)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__check"
                ;;
            batten__subcmd__lease__subcmd__help,guard)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__guard"
                ;;
            batten__subcmd__lease__subcmd__help,held)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__held"
                ;;
            batten__subcmd__lease__subcmd__help,help)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__lease__subcmd__help,hold)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__hold"
                ;;
            batten__subcmd__lease__subcmd__help,peek)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__peek"
                ;;
            batten__subcmd__lease__subcmd__help,release)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__release"
                ;;
            batten__subcmd__lease__subcmd__help,renew)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__renew"
                ;;
            batten__subcmd__lease__subcmd__help,reserve)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__reserve"
                ;;
            batten__subcmd__lease__subcmd__help,status)
                cmd="batten__subcmd__lease__subcmd__help__subcmd__status"
                ;;
            ...
            batten__subcmd__mcp__subcmd__help,spawn)
                ...
                ;;
            batten__subcmd__mutate,census)
                cmd="batten__subcmd__mutate__subcmd__census"
                ;;
            batten__subcmd__mutate,help)
                cmd="batten__subcmd__mutate__subcmd__help"
                ;;
            batten__subcmd__mutate,sweep)
                cmd="batten__subcmd__mutate__subcmd__sweep"
                ;;
            batten__subcmd__mutate__subcmd__help,census)
                cmd="batten__subcmd__mutate__subcmd__help__subcmd__census"
                ;;
            batten__subcmd__mutate__subcmd__help,help)
                cmd="batten__subcmd__mutate__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__mutate__subcmd__help,sweep)
                cmd="batten__subcmd__mutate__subcmd__help__subcmd__sweep"
                ;;
            ...
            batten__subcmd__payload__subcmd__help,help)
                ...
                ;;
            batten__subcmd__perf,compare)
                cmd="batten__subcmd__perf__subcmd__compare"
                ;;
            batten__subcmd__perf,gate)
                cmd="batten__subcmd__perf__subcmd__gate"
                ;;
            ...
            batten__subcmd__perf,pair)
                ...
                ;;
            batten__subcmd__perf,record)
                cmd="batten__subcmd__perf__subcmd__record"
                ;;
            batten__subcmd__perf__subcmd__help,compare)
                cmd="batten__subcmd__perf__subcmd__help__subcmd__compare"
                ;;
            batten__subcmd__perf__subcmd__help,gate)
                cmd="batten__subcmd__perf__subcmd__help__subcmd__gate"
                ;;
            ...
            batten__subcmd__perf__subcmd__help,pair)
                ...
                ;;
            batten__subcmd__perf__subcmd__help,record)
                cmd="batten__subcmd__perf__subcmd__help__subcmd__record"
                ;;
            ...
            batten__subcmd__policy,help)
                ...
                ;;
            batten__subcmd__policy,hooks)
                cmd="batten__subcmd__policy__subcmd__hooks"
                ;;
            batten__subcmd__policy,rule)
                cmd="batten__subcmd__policy__subcmd__rule"
                ;;
            ...
            batten__subcmd__policy__subcmd__help,help)
                ...
                ;;
            batten__subcmd__policy__subcmd__help,hooks)
                cmd="batten__subcmd__policy__subcmd__help__subcmd__hooks"
                ;;
            batten__subcmd__policy__subcmd__help,rule)
                cmd="batten__subcmd__policy__subcmd__help__subcmd__rule"
                ;;
            ...
            batten__subcmd__policy__subcmd__help,tools)
                ...
                ;;
            batten__subcmd__pr,closes)
                cmd="batten__subcmd__pr__subcmd__closes"
                ;;
            batten__subcmd__pr,derive)
                cmd="batten__subcmd__pr__subcmd__derive"
                ;;
            batten__subcmd__pr,ensure)
                cmd="batten__subcmd__pr__subcmd__ensure"
                ;;
            batten__subcmd__pr,file)
                cmd="batten__subcmd__pr__subcmd__file"
                ;;
            batten__subcmd__pr,help)
                cmd="batten__subcmd__pr__subcmd__help"
                ;;
            ...
            batten__subcmd__pr,watch)
                ...
                ;;
            batten__subcmd__pr__subcmd__help,closes)
                cmd="batten__subcmd__pr__subcmd__help__subcmd__closes"
                ;;
            batten__subcmd__pr__subcmd__help,derive)
                cmd="batten__subcmd__pr__subcmd__help__subcmd__derive"
                ;;
            batten__subcmd__pr__subcmd__help,ensure)
                cmd="batten__subcmd__pr__subcmd__help__subcmd__ensure"
                ;;
            batten__subcmd__pr__subcmd__help,file)
                cmd="batten__subcmd__pr__subcmd__help__subcmd__file"
                ;;
            batten__subcmd__pr__subcmd__help,help)
                cmd="batten__subcmd__pr__subcmd__help__subcmd__help"
                ;;
            ...
            batten__subcmd__ready__subcmd__help,lint)
                ...
                ;;
            batten__subcmd__receipt,clean)
                cmd="batten__subcmd__receipt__subcmd__clean"
                ;;
            ...
            batten__subcmd__receipt,status)
                ...
                ;;
            batten__subcmd__receipt,verified)
                cmd="batten__subcmd__receipt__subcmd__verified"
                ;;
            batten__subcmd__receipt__subcmd__help,clean)
                cmd="batten__subcmd__receipt__subcmd__help__subcmd__clean"
                ;;
            ...
            batten__subcmd__record,fold)
                ...
                ;;
            batten__subcmd__record,forge)
                cmd="batten__subcmd__record__subcmd__forge"
                ;;
            batten__subcmd__record,help)
                cmd="batten__subcmd__record__subcmd__help"
                ;;
            batten__subcmd__record,journal)
                cmd="batten__subcmd__record__subcmd__journal"
                ;;
            batten__subcmd__record,keyed)
                cmd="batten__subcmd__record__subcmd__keyed"
                ;;
            ...
            batten__subcmd__record,show)
                ...
                ;;
            batten__subcmd__record,suites)
                cmd="batten__subcmd__record__subcmd__suites"
                ;;
            ...
            batten__subcmd__record__subcmd__help,fold)
                ...
                ;;
            batten__subcmd__record__subcmd__help,forge)
                cmd="batten__subcmd__record__subcmd__help__subcmd__forge"
                ;;
            batten__subcmd__record__subcmd__help,help)
                cmd="batten__subcmd__record__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__record__subcmd__help,journal)
                cmd="batten__subcmd__record__subcmd__help__subcmd__journal"
                ;;
            batten__subcmd__record__subcmd__help,keyed)
                cmd="batten__subcmd__record__subcmd__help__subcmd__keyed"
                ;;
            ...
            batten__subcmd__record__subcmd__help,show)
                ...
                ;;
            batten__subcmd__record__subcmd__help,suites)
                cmd="batten__subcmd__record__subcmd__help__subcmd__suites"
                ;;
            ...
            batten__subcmd__show__subcmd__help,agent)
                ...
                ;;
            batten__subcmd__show__subcmd__help,help)
                cmd="batten__subcmd__show__subcmd__help__subcmd__help"
                ;;
            ...
            batten__subcmd__singleton,help)
                ...
                ;;
            batten__subcmd__singleton,release)
                cmd="batten__subcmd__singleton__subcmd__release"
                ;;
            ...
            batten__subcmd__singleton__subcmd__help,help)
                ...
                ;;
            batten__subcmd__singleton__subcmd__help,release)
                cmd="batten__subcmd__singleton__subcmd__help__subcmd__release"
                ;;
            ...
            batten__subcmd__state,record)
                ...
                ;;
            batten__subcmd__state,settle)
                cmd="batten__subcmd__state__subcmd__settle"
                ;;
            ...
            batten__subcmd__target,help)
                ...
                ;;
            batten__subcmd__target,prune)
                cmd="batten__subcmd__target__subcmd__prune"
                ;;
            batten__subcmd__target__subcmd__help,help)
                cmd="batten__subcmd__target__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__target__subcmd__help,prune)
                cmd="batten__subcmd__target__subcmd__help__subcmd__prune"
                ;;
            batten__subcmd__task,alive)
                cmd="batten__subcmd__task__subcmd__alive"
                ;;
            batten__subcmd__task,help)
                cmd="batten__subcmd__task__subcmd__help"
                ;;
            batten__subcmd__task,phase)
                cmd="batten__subcmd__task__subcmd__phase"
                ;;
            batten__subcmd__task,read)
                cmd="batten__subcmd__task__subcmd__read"
                ;;
            batten__subcmd__task,register)
                cmd="batten__subcmd__task__subcmd__register"
                ;;
            batten__subcmd__task,sig)
                cmd="batten__subcmd__task__subcmd__sig"
                ;;
            batten__subcmd__task,tick)
                cmd="batten__subcmd__task__subcmd__tick"
                ;;
            batten__subcmd__task,unregister)
                cmd="batten__subcmd__task__subcmd__unregister"
                ;;
            batten__subcmd__task__subcmd__help,alive)
                cmd="batten__subcmd__task__subcmd__help__subcmd__alive"
                ;;
            batten__subcmd__task__subcmd__help,help)
                cmd="batten__subcmd__task__subcmd__help__subcmd__help"
                ;;
            batten__subcmd__task__subcmd__help,phase)
                cmd="batten__subcmd__task__subcmd__help__subcmd__phase"
                ;;
            batten__subcmd__task__subcmd__help,read)
                cmd="batten__subcmd__task__subcmd__help__subcmd__read"
                ;;
            batten__subcmd__task__subcmd__help,register)
                cmd="batten__subcmd__task__subcmd__help__subcmd__register"
                ;;
            batten__subcmd__task__subcmd__help,sig)
                cmd="batten__subcmd__task__subcmd__help__subcmd__sig"
                ;;
            batten__subcmd__task__subcmd__help,tick)
                cmd="batten__subcmd__task__subcmd__help__subcmd__tick"
                ;;
    ...
    case "${cmd}" in
        batten)
            ...
            return 0
            ;;
        batten__subcmd__adjudicate)
            opts="-q -v -y -h --instant --harness --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
        ...
        batten__subcmd__attribution__subcmd__check)
            opts="-J -q -v -y -h --json --message --harness --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
        ...
        batten__subcmd__baseline)
            ...
            return 0
            ;;
        batten__subcmd__bench)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help tokens help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__bench__subcmd__help)
            opts="tokens help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__bench__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__bench__subcmd__help__subcmd__tokens)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__bench__subcmd__tokens)
        ...
        batten__subcmd__capture__subcmd__find)
            opts="-J -q -v -y -h --tool --key-at --raw --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__capture__subcmd__list)
            opts="-J -q -v -y -h --stream --calls --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__capture__subcmd__prune)
            opts="-n -q -v -y -h --dry-run --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__capture__subcmd__show)
            opts="-J -q -v -y -h --lines --grep --raw --bytes --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__check)
            ...
            return 0
            ;;
        batten__subcmd__checks)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help green help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__checks__subcmd__green)
            ...
            return 0
            ;;
        batten__subcmd__checks__subcmd__help)
            opts="green help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__checks__subcmd__help__subcmd__green)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__checks__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__ci__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__ci__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__ci__subcmd__help__subcmd__slow__subcmd__needed)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__claim)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help merged keys check bot race carry help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__bot)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__carry)
            opts="-J -q -v -y -h --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__claim__subcmd__check)
            opts="-J -q -v -y -h --takeover --bypass-sequence --adopt --adopt-from --issue --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__claim__subcmd__help)
            opts="merged keys check bot race carry help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__help__subcmd__bot)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__help__subcmd__carry)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__claim__subcmd__help__subcmd__keys)
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__help__subcmd__merged)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__claim__subcmd__help__subcmd__race)
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__keys)
            opts="-q -v -y -h --branch --title --log --closing-only --refs-first-only --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__merged)
            opts="-q -v -y -h --limit --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__claim__subcmd__race)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__commit__subcmd__check)
            opts="-J -q -v -y -h --json --message --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__config)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help show epoch deprecations lint help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__config__subcmd__epoch)
            opts="-J -q -v -y -h --json --no-cache --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__config__subcmd__lint)
            opts="-J -q -v -y -h --json --host-rules --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__defects)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help query add help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__defects__subcmd__query)
            opts="-J -q -v -y -h --json --class --id --ungated --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__design)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help audit help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__doctor__subcmd__help__subcmd__session)
            ...
            return 0
            ;;
        batten__subcmd__doctor__subcmd__help__subcmd__target)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__doctor__subcmd__help__subcmd__toolchain)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__doctor__subcmd__session)
            ...
            return 0
            ;;
        batten__subcmd__doctor__subcmd__target)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__doctor__subcmd__toolchain)
            opts="-J -q -v -y -h --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__generate)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help completions hooks man markdown schema help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__generate__subcmd__completions)
            opts="-q -v -y -h --shell --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__generate__subcmd__hooks)
            opts="-q -v -y -h --harness --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__generate__subcmd__schema)
            opts="-q -v -y -h --surface --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__adjudicate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__baseline)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__bench)
            opts="tokens"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__check)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__checks)
            opts="green"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__checks__subcmd__green)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__claim)
            opts="merged keys check bot race carry"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__help__subcmd__claim__subcmd__bot)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__claim__subcmd__carry)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__claim__subcmd__check)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__claim__subcmd__keys)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__claim__subcmd__merged)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__doctor__subcmd__session)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__doctor__subcmd__target)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__doctor__subcmd__toolchain)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__hk)
            opts="contract observe drift"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__hk__subcmd__contract)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__hk__subcmd__drift)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__hk__subcmd__observe)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__land__subcmd__replay)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__land__subcmd__verify)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__landed__subcmd__abandoned)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__landed__subcmd__check)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__lease)
            opts="authorises carries guard check status peek held acquire renew hold release reserve"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__acquire)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__lease__subcmd__guard)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__held)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__hold)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__peek)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__release)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__renew)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__reserve)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__lease__subcmd__status)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__mcp__subcmd__call)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__mcp__subcmd__spawn)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__mutate__subcmd__census)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__mutate__subcmd__sweep)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__perf)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__perf__subcmd__compare)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__perf__subcmd__gate)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__perf__subcmd__measure)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__perf__subcmd__pair)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__perf__subcmd__record)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__policy)
            opts="budget hooks test tools explain rule"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__help__subcmd__policy__subcmd__explain)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__policy__subcmd__hooks)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__policy__subcmd__rule)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__pr)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__pr__subcmd__closes)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__pr__subcmd__derive)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__pr__subcmd__link)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__pr__subcmd__watch)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__receipt)
            opts="clean record status verified"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__receipt__subcmd__clean)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__record__subcmd__closes)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__record__subcmd__fold)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__record__subcmd__journal)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__record__subcmd__keyed)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__record__subcmd__show)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__record__subcmd__suites)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__record__subcmd__tool)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__show)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__show__subcmd__agent)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__singleton__subcmd__acquire)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__singleton__subcmd__release)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__spec)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__startup)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__state)
            opts="adopt record migrate settle list"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__help__subcmd__state__subcmd__settle)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__target)
            opts="prune"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__target__subcmd__prune)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task)
            opts="register phase tick sig unregister read alive"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__alive)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__phase)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__read)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__register)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__sig)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__task__subcmd__tick)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__task__subcmd__unregister)
            ...
            return 0
            ;;
        batten__subcmd__help__subcmd__verdict)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__help__subcmd__worktree__subcmd__status)
            ...
            ;;
        batten__subcmd__hk)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help contract observe drift help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__contract)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__drift)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__hk__subcmd__help)
            opts="contract observe drift help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__help__subcmd__contract)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__help__subcmd__drift)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__help__subcmd__observe)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__hk__subcmd__observe)
            opts="-q -v -y -h --session --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__land)
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__fast__subcmd__forward)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__land__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__help__subcmd__fast__subcmd__forward)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__land__subcmd__help__subcmd__lap)
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__help__subcmd__push)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__help__subcmd__replay)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__help__subcmd__verify)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__land__subcmd__lap)
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__push)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__land__subcmd__replay)
            ...
            return 0
            ;;
        batten__subcmd__land__subcmd__verify)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__landed__subcmd__help__subcmd__abandoned)
            ...
            return 0
            ;;
        batten__subcmd__landed__subcmd__help__subcmd__check)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__landed__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lease)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help authorises carries guard check status peek held acquire renew hold release reserve help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__acquire)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__authorises)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__carries)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lease__subcmd__check)
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__guard)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lease__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__acquire)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lease__subcmd__help__subcmd__check)
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__guard)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lease__subcmd__help__subcmd__held)
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__hold)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__peek)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__release)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__renew)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__reserve)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__help__subcmd__status)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__hold)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__peek)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__release)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__renew)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__reserve)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__lease__subcmd__status)
            opts="-J -q -v -y -h --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__lint)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help brief help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__mcp)
            ...
            return 0
            ;;
        batten__subcmd__mcp__subcmd__call)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__mcp__subcmd__help__subcmd__call)
            ...
            return 0
            ;;
        batten__subcmd__mcp__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__mcp__subcmd__help__subcmd__spawn)
            ...
            return 0
            ;;
        batten__subcmd__mcp__subcmd__spawn)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__mutate)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help sweep census help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__mutate__subcmd__census)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__mutate__subcmd__help)
            opts="sweep census help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__mutate__subcmd__help__subcmd__census)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__override)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help request spend help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__override__subcmd__request)
            opts="-q -v -y -h --rule --verdict --subject --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__override__subcmd__spend)
            opts="-q -v -y -h --admission --rule --verdict --subject --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__payload)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help field help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__payload__subcmd__field)
            opts="-q -v -y -h --harness --name --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__perf)
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__compare)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__gate)
            opts="-q -v -y -h --null --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__perf__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__help__subcmd__compare)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__help__subcmd__gate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__perf__subcmd__help__subcmd__pair)
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__help__subcmd__record)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__measure)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__perf__subcmd__pair)
            ...
            return 0
            ;;
        batten__subcmd__perf__subcmd__record)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__policy)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help budget hooks test tools explain rule help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__policy__subcmd__help)
            opts="budget hooks test tools explain rule help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__policy__subcmd__help__subcmd__hooks)
            ...
            return 0
            ;;
        batten__subcmd__policy__subcmd__help__subcmd__rule)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__policy__subcmd__hooks)
            ...
            return 0
            ;;
        batten__subcmd__policy__subcmd__rule)
            opts="-J -q -v -y -h --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__closes)
            ...
            return 0
            ;;
        batten__subcmd__pr__subcmd__derive)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__ensure)
            ...
            return 0
            ;;
        batten__subcmd__pr__subcmd__file)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__help__subcmd__closes)
            ...
            return 0
            ;;
        batten__subcmd__pr__subcmd__help__subcmd__derive)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__help__subcmd__ensure)
            ...
            return 0
            ;;
        batten__subcmd__pr__subcmd__help__subcmd__file)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__help__subcmd__watch)
            ...
            return 0
            ;;
        batten__subcmd__pr__subcmd__link)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__pr__subcmd__watch)
            opts="-q -v -y -h --sha --repo --interval --progress --progress-id --required --absent-ok --answered --fanin --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__provision)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help status apply help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__ready__subcmd__lint)
            opts="-J -q -v -y -h --issue --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__receipt)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help clean record status verified help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__receipt__subcmd__clean)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__receipt__subcmd__help)
            opts="clean record status verified help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__receipt__subcmd__help__subcmd__clean)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__receipt__subcmd__help__subcmd__status)
            ...
            return 0
            ;;
        batten__subcmd__receipt__subcmd__help__subcmd__verified)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__closes)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record__subcmd__help__subcmd__forge)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record__subcmd__help__subcmd__journal)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__help__subcmd__keyed)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__help__subcmd__named)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record__subcmd__help__subcmd__plan)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__help__subcmd__show)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__help__subcmd__suites)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record__subcmd__journal)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__keyed)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__named)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__record__subcmd__plan)
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__show)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__record__subcmd__suites)
            opts="-q -v -y -h --write --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__release__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__release__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__release__subcmd__help__subcmd__install)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__semver__subcmd__check)
            opts="-q -v -y -h --baseline --release-type --package --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__show__subcmd__help__subcmd__agent)
            ...
            return 0
            ;;
        batten__subcmd__show__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__singleton)
            ...
            return 0
            ;;
        batten__subcmd__singleton__subcmd__acquire)
            opts="-q -v -y -h --recheck-ms --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__singleton__subcmd__help__subcmd__acquire)
            ...
            return 0
            ;;
        batten__subcmd__singleton__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__singleton__subcmd__help__subcmd__release)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__singleton__subcmd__release)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__spec)
            opts="-q -v -y -h --format --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__startup)
            opts="-J -q -v -y -h --repair --json --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__state)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help adopt record migrate settle list help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__state__subcmd__help)
            opts="adopt record migrate settle list help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__state__subcmd__settle)
            ...
            return 0
            ;;
        batten__subcmd__target)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help prune help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__target__subcmd__help)
            opts="prune help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__target__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__target__subcmd__help__subcmd__prune)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__target__subcmd__prune)
            opts="-n -q -v -y -h --dry-run --root --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__task)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help register phase tick sig unregister read alive help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__alive)
            opts="-q -v -y -h --program-root --instant --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help)
            opts="register phase tick sig unregister read alive help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__alive)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__phase)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__read)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__register)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__sig)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__tick)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__help__subcmd__unregister)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__phase)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__read)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__register)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__sig)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__tick)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__task__subcmd__unregister)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__verdict)
            opts="-q -v -y -h --findings --unjudgeable --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        batten__subcmd__wiring__subcmd__help)
            ...
            return 0
            ;;
        batten__subcmd__wiring__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        batten__subcmd__wiring__subcmd__help__subcmd__reclaim)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        batten__subcmd__worktree)
            opts="-q -v -y -h --strictness --fail-on-warning --config-from --config-in --silent --quiet --verbose --debug --trace --log-level --no-color --no-input --yes --help status help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
