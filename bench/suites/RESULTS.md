...
| seconds | share | suite |
| ---: | ---: | --- |
| 146.9 | 15.7% | `tests/land-lock.bats` |
| 106.7 | 11.4% | `tests/derived-check.bats` |
| 102.2 | 10.9% | `tests/ci-wait.bats` |
| 80.4 | 8.6% | `tests/land.bats` |
| 54.9 | 5.9% | `tests/hooks-wiring-check.bats` |
| 41.0 | 4.4% | `tests/ci-local-parity.bats` |
| 34.6 | 3.7% | `tests/main-watch.bats` |
| 26.1 | 2.8% | `tests/helpers.bats` |
| 24.3 | 2.6% | `tests/hook-latency-drift.bats` |
| 17.3 | 1.8% | `tests/claim-check.bats` |
| 15.1 | 1.6% | `tests/board-diff-overlap.bats` |
| 10.5 | 1.1% | `tests/config-lint.bats` |
| 10.4 | 1.1% | `tests/prebuilt-lint.bats` |
| 9.9 | 1.1% | `tests/graph-check.bats` |
| 9.7 | 1.0% | `tests/board-write-record.bats` |
| 8.7 | 0.9% | `tests/run-shape-guard.bats` |
| 8.4 | 0.9% | `tests/token-bench.bats` |
| 7.5 | 0.8% | `tests/target-race.bats` |
| 7.0 | 0.8% | `tests/filed-here-check.bats` |
| 7.0 | 0.7% | `tests/mcp-allow-check.bats` |
| 6.7 | 0.7% | `tests/ready-lint.bats` |
| 6.3 | 0.7% | `tests/ready-guard.bats` |
| 6.0 | 0.6% | `tests/renovate-config-validator.bats` |
| 6.0 | 0.6% | `tests/stop-guard.bats` |
| 5.6 | 0.6% | `tests/released.bats` |
| 5.5 | 0.6% | `tests/lock-complete.bats` |
| 5.3 | 0.6% | `tests/sbom-check.bats` |
| 5.0 | 0.5% | `tests/replay.bats` |
| 5.0 | 0.5% | `tests/session-start.bats` |
| 4.9 | 0.5% | `tests/step-receipt.bats` |
| 4.8 | 0.5% | `tests/pre-commit-staging.bats` |
| 4.6 | 0.5% | `tests/singleton.bats` |
| 4.5 | 0.5% | `tests/in-progress-drain.bats` |
| 4.4 | 0.5% | `tests/release-assets-check.bats` |
| 4.3 | 0.5% | `tests/board-move-guard.bats` |
| 4.0 | 0.4% | `tests/task-registry.bats` |
| 4.0 | 0.4% | `tests/land-divergence.bats` |
| 3.6 | 0.4% | `tests/schema-check.bats` |
| 3.6 | 0.4% | `tests/doctor-race.bats` |
| 3.4 | 0.4% | `tests/board-sweep.bats` |
| 3.3 | 0.3% | `tests/reference-check.bats` |
| 3.1 | 0.3% | `tests/with-lock.bats` |
| 3.1 | 0.3% | `tests/mutant.bats` |
| 3.0 | 0.3% | `tests/semver.bats` |
| 3.0 | 0.3% | `tests/issue-read-check.bats` |
| 2.9 | 0.3% | `tests/target-ensure.bats` |
| 2.9 | 0.3% | `tests/fanout-guard.bats` |
| 2.5 | 0.3% | `tests/hk-selection.bats` |
| 2.5 | 0.3% | `tests/issue-read-guard.bats` |
