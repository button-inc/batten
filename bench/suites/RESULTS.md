...
| seconds | share | suite |
| ---: | ---: | --- |
| 133.5 | 15.2% | `tests/land-lock.bats` |
| 102.2 | 11.6% | `tests/derived-check.bats` |
| 102.2 | 11.6% | `tests/ci-wait.bats` |
| 78.2 | 8.9% | `tests/land.bats` |
| 39.4 | 4.5% | `tests/hooks-wiring-check.bats` |
| 36.1 | 4.1% | `tests/helpers.bats` |
| 34.6 | 3.9% | `tests/main-watch.bats` |
| 33.1 | 3.8% | `tests/ci-local-parity.bats` |
| 24.3 | 2.8% | `tests/hook-latency-drift.bats` |
| 15.7 | 1.8% | `tests/claim-check.bats` |
| 13.1 | 1.5% | `tests/board-diff-overlap.bats` |
| 9.4 | 1.1% | `tests/graph-check.bats` |
| 9.2 | 1.0% | `tests/config-lint.bats` |
| 8.9 | 1.0% | `tests/target-race.bats` |
| 8.3 | 0.9% | `tests/board-write-record.bats` |
| 8.0 | 0.9% | `tests/run-shape-guard.bats` |
| 7.9 | 0.9% | `tests/token-bench.bats` |
| 6.8 | 0.8% | `tests/mcp-allow-check.bats` |
| 6.6 | 0.8% | `tests/prebuilt-lint.bats` |
| 6.4 | 0.7% | `tests/ready-guard.bats` |
| 6.4 | 0.7% | `tests/ready-lint.bats` |
| 6.3 | 0.7% | `tests/filed-here-check.bats` |
| 6.1 | 0.7% | `tests/renovate-config-validator.bats` |
| 5.8 | 0.7% | `tests/stop-guard.bats` |
| 5.7 | 0.6% | `tests/released.bats` |
| 5.2 | 0.6% | `tests/lock-complete.bats` |
| 5.2 | 0.6% | `tests/contract-drift.bats` |
| 5.2 | 0.6% | `tests/step-receipt.bats` |
| 5.1 | 0.6% | `tests/session-start.bats` |
| 4.8 | 0.5% | `tests/sbom-check.bats` |
...
| 3.6 | 0.4% | `tests/board-move-guard.bats` |
| 3.5 | 0.4% | `tests/doctor-race.bats` |
| 3.4 | 0.4% | `tests/pre-commit-staging.bats` |
| 3.3 | 0.4% | `tests/reference-check.bats` |
| 3.2 | 0.4% | `tests/land-divergence.bats` |
| 3.1 | 0.4% | `tests/with-lock.bats` |
| 3.1 | 0.4% | `tests/target-ensure.bats` |
| 2.9 | 0.3% | `tests/mutant.bats` |
| 2.9 | 0.3% | `tests/issue-read-check.bats` |
| 2.8 | 0.3% | `tests/board-sweep.bats` |
| 2.7 | 0.3% | `tests/semver.bats` |
| 2.5 | 0.3% | `tests/ready-cites-check.bats` |
| 2.4 | 0.3% | `tests/issue-read-guard.bats` |
...
| 1.5 | 0.2% | `tests/ci-slow-needed.bats` |
...
| 0.8 | 0.1% | `tests/closing-key-check.bats` |
