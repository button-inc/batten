...
//!
// carried: "connector-verb-guard.bats::a subscribe under the readable name is denied" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::send_later under the readable name is denied" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::create_trigger under the readable name is denied" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::a subscribe under a UUID server name is denied" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::send_later under a UUID server name is denied" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::an unsubscribe under the readable name is left undecided" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::an unsubscribe under a UUID server name is left undecided" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::the unsubscribe suffix is not swallowed by the subscribe suffix" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::a verb with no server prefix is still decided" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::a tool merely CONTAINING a decided verb is not decided" crates/batten/tests/connector_verbs.rs
// carried: "connector-verb-guard.bats::an unrelated tool gets no decision" crates/batten/tests/connector_verbs.rs
...
//! produce.
//!
// subsumed: "connector-verb-guard.bats::a payload with no tool_name gets no decision" crates/batten/tests/cli.rs
// subsumed: "connector-verb-guard.bats::unparseable stdin gets no decision rather than a deny" crates/batten/tests/cli.rs
//!
...
//!
// changed: "connector-verb-guard.bats::--covers prints every suffix the guard decides, and nothing else" crates/batten/tests/cli.rs the guard's `--covers` is `batten policy tools`, which reads the committed rows rather than a script's `case` arms — one authority for the fact instead of two. Asserted over the real config in `policy_tools_names_every_mediated_selector`
...
// changed: "connector-verb-guard.bats::the bypass silences every arm" crates/batten/tests/guardrail_bypass.rs BATTEN_CONNECTOR_VERB_BYPASS is gone; a mediated deny takes the engine's own hatch, the consolidation rows 1-3 and 6 record
//!
