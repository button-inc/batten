...
//
// carried: mise-tasks/mise-pin-agreement.sh policy/mise-pin-agreement.rego crates/batten/tests/it/mise_pin_agreement.rs
// carried: tests/mise-pin-agreement.bats policy/mise-pin-agreement.rego crates/batten/tests/it/mise_pin_agreement.rs
...
// carried: "a scoped launch whose version matches mise.toml passes" crates/batten/tests/it/mise_pin_agreement.rs
// carried: "a shimmed launch that IS scoped passes, and its pin is still read" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "a version .mcp.json names that mise.toml does not pin fails, naming both" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "a tool mise.toml does not carry at all fails" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "a bare \`mise exec\` fails even though it names no version to compare" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "A SHIMMED LAUNCH IS STILL CHECKED — the selector is argv, not the command name" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "a server not launched through mise is left alone" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// carried: "a missing .mcp.json is nothing to check" crates/batten/tests/it/mise_pin_agreement.rs
#[test]
...
// what `crates/batten/tests/it/privileged_lane.rs` records for the same channel. The
...
// changed: "an unparseable .mcp.json is exit 2, never a clean pass" crates/batten/tests/it/mise_pin_agreement.rs CLOUD-1049: `input.tree.missing` is not populated for a declared document that exists and fails to parse, so the could-not-look clause the module already carries cannot see this input. Not shipped red and not shipped asserting the current behaviour; CLOUD-1049 owns restoring it here
