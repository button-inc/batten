...
//!
// carried: "a Todo issue with nobody on it is pullable" crates/batten/tests/it/claim.rs
// carried: "the pullable message says to claim it, because the automation will not" crates/batten/tests/it/claim.rs
// carried: "an issue already In Progress is not pullable" crates/batten/tests/it/claim.rs
// carried: "In Review and Done are not pullable either" crates/batten/tests/it/claim.rs
// carried: "a Todo issue someone has already assigned is flagged" crates/batten/tests/it/claim.rs
// carried: "a Todo issue with a PR already attached is flagged, with the PR number" crates/batten/tests/it/claim.rs
// carried: "a non-PR attachment is not a claim" crates/batten/tests/it/claim.rs
// carried: "output is pointer-only — the issue id and the rule, never a body" crates/batten/tests/it/claim.rs
// carried: "a set of issues is judged as a set, and one bad apple blocks" crates/batten/tests/it/claim.rs
// carried: "a JSON array is accepted as well as a stream, matching graph-check" crates/batten/tests/it/claim.rs
// carried: "unreadable stdin is exit 2, distinct from a failing check" crates/batten/tests/it/claim.rs
// carried: "empty stdin is exit 2, not a silent pass" crates/batten/tests/it/claim.rs
// carried: "a payload missing status is unreadable rather than assumed Todo" crates/batten/tests/it/claim.rs
// carried: "not-todo, assigned and has-pr are each reachable on a payload with no description" crates/batten/tests/it/claim.rs
// carried: "a bodyless payload nothing else refuses is exit 2 naming description, never a pass" crates/batten/tests/it/claim.rs
// carried: "the pullable path mints a receipt for the current branch" crates/batten/tests/it/claim.rs
// carried: "a NOT-pullable issue mints nothing — the receipt is the claim, not the attempt" crates/batten/tests/it/claim.rs
// carried: "the id list stays line 1 with a clause recorded" crates/batten/tests/it/claim.rs
// carried: "unreadable stdin mints nothing either" crates/batten/tests/it/claim.rs
// carried: "outside a checkout the verdict still stands — the receipt is a side effect" crates/batten/tests/it/claim.rs
// carried: "THE INCIDENT REPLAY: an issue refined inside this session is refused at the claim" crates/batten/tests/it/claim.rs
// carried: "the legitimate path is not prompted, delayed or refused" crates/batten/tests/it/claim.rs
// carried: "a block ready-lint refuses mints no receipt" crates/batten/tests/it/claim.rs
// carried: "the refusal is pointer-only — the rule id, never the block it read" crates/batten/tests/it/claim.rs
// carried: "CLOUD-597 REPLAY: a row whose updatedAt moved but whose BODY did not is pullable" crates/batten/tests/it/claim.rs
// carried: "CLOUD-615 REPLAY: a body rewritten under this clone is refused even when the stamp is NEWER" crates/batten/tests/it/claim.rs
// carried: "a receipt minted the way the engine mints it is accepted" crates/batten/tests/it/claim.rs
// carried: "the baseline refusal is pointer-only — never a line of the body it compared" crates/batten/tests/it/claim.rs
// carried: "a missing session stamp REFUSES rather than passing" crates/batten/tests/it/claim.rs
// carried: "A DELETED READ RECEIPT IS A REFUSAL, never a fall-through to the clock" crates/batten/tests/it/claim.rs
// carried: "the refusal names its remedy, and it is one command over the payload in hand" crates/batten/tests/it/claim.rs
// carried: "a HOLLOW receipt is absence, not a weaker yes" crates/batten/tests/it/claim.rs
// carried: "OUTSIDE a checkout the question stays not-applicable, exactly as the stamp does" crates/batten/tests/it/claim.rs
// carried: "a receipt store this process cannot read is exit 2 — could not look, not absent" crates/batten/tests/it/claim.rs
// carried: "the bypass clears the absent baseline too, and says so in the receipt" crates/batten/tests/it/claim.rs
// carried: "--takeover does NOT clear an absent baseline" crates/batten/tests/it/claim.rs
// carried: "the bypass mints a receipt in BOTH refused cases, and says so" crates/batten/tests/it/claim.rs
// carried: "the receipt records the verdict and the revision it was taken against" crates/batten/tests/it/claim.rs
// carried: "the receipt records the origin/main it was claimed against" crates/batten/tests/it/claim.rs
// carried: "a bypassed claim says so IN the receipt, not only on stderr" crates/batten/tests/it/claim.rs
// carried: "an occupied issue is refused when no takeover is asked for" crates/batten/tests/it/claim.rs
// carried: "THE TAKEOVER: an occupied issue is claimable deliberately, and mints a receipt" crates/batten/tests/it/claim.rs
// carried: "a takeover receipt NAMES the refusals it overrode, never a bare flag" crates/batten/tests/it/claim.rs
// carried: "a clean claim records no takeover line" crates/batten/tests/it/claim.rs
// carried: "a sequence refusal is NOT cleared by --takeover" crates/batten/tests/it/claim.rs
// carried: "the sequence refusal names the bypass, not the takeover" crates/batten/tests/it/claim.rs
// carried: "the bypass DOES clear a sequence refusal, so the two hatches stay distinct" crates/batten/tests/it/claim.rs
// carried: "narrowing the takeover does not break it: a competitor refusal still clears" crates/batten/tests/it/claim.rs
// carried: "the takeover does not silence the refusals — they are still reported" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause a — a MERGED pull request is a predecessor, not a competitor" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause a — the SAME payload without the state still refuses" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause b — a CLOSED unmerged pull request does not refuse either" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause b — the merged BOOLEAN alone is enough, without a state string" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause c — an OPEN pull request still refuses — the rule is not deleted" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause d — a malformed state refuses rather than reading as merged" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause d — the state is read case-insensitively, as the API spells it" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 clause e — a non-PR attachment carrying a state is still ignored" crates/batten/tests/it/claim.rs
// carried: "CLOUD-520 remedy — the refusal names the remedy, not merely the refusal" crates/batten/tests/it/claim.rs
// carried: "the minted receipt records the branch it was minted for" crates/batten/tests/it/claim.rs
// carried: "A RENAMED BRANCH RECOVERS ITS CLAIM WITH --adopt" crates/batten/tests/it/claim.rs
// carried: "WITHOUT --adopt the rename is still unrecovered — the recovery is opt-in" crates/batten/tests/it/claim.rs
// carried: "the adoption is recorded, never silent" crates/batten/tests/it/claim.rs
// carried: "a receipt whose branch still exists is not adopted" crates/batten/tests/it/claim.rs
// carried: "adopting onto a branch that already has a receipt is refused" crates/batten/tests/it/claim.rs
// carried: "a receipt with no branch line is not adoptable, never grandfathered" crates/batten/tests/it/claim.rs
// carried: "two orphans refuse and name both rather than guessing" crates/batten/tests/it/claim.rs
// carried: "--adopt-from picks one when two orphans are present" crates/batten/tests/it/claim.rs
// carried: "a detached HEAD has no name to adopt onto" crates/batten/tests/it/claim.rs
// carried: "THE TAKEOVER AS A FLAG: reachable where an env-var bypass is classified" crates/batten/tests/it/claim.rs
// carried: "an unknown flag is a usage error, not a silent pull" crates/batten/tests/it/claim.rs
// carried: "--adopt-from with no value is refused, and does not hang" crates/batten/tests/it/claim.rs
// carried: "--adopt-from with an empty value is refused rather than silently defaulted" crates/batten/tests/it/claim.rs
//!
...
//!
// changed: "the flag and the env var record the identical line" crates/batten/tests/it/claim.rs the env var is gone rather than ported, so there is no second spelling for a receipt to record identically and the case describes a pair that no longer exists
