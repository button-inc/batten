...
//
// carried: mise-tasks/schema-check.sh crates/batten/src/config.rs kind:mechanism crates/batten/tests/it/config_schema.rs
// carried: tests/schema-check.bats mise-tasks/schema-check.sh crates/batten/src/config.rs kind:mechanism crates/batten/tests/it/config_schema.rs
//
...
// `unconserved_cases`).
//
// carried: "schema-check.bats::a committed schema matching the config types exits 0" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::a drifted override schema is reported with its own pointer" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::a missing override schema is reported rather than silently skipped" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::both surfaces are judged in one run, not just the first to fail" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::a drifted schema is reported with a pointer" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::a missing schema is reported rather than silently skipped" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::output is pointer-only — no schema body echoed" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::the gate leaves the tree it judges unmodified" crates/batten/tests/it/config_schema.rs
// carried: "schema-check.bats::this repo's committed schema matches its config types — the gate on the real tree" crates/batten/tests/it/config_schema.rs
