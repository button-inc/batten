...
//!
// carried: "a ready with no record at all is refused, and the receipt row names the command" crates/batten/tests/it/review_answered.rs
// carried: "a head whose threads are all answered is allowed" crates/batten/tests/it/review_answered.rs
// carried: "VACUITY: a buffer that is not the declared shape records nothing rather than one row" crates/batten/tests/it/review_answered.rs
// carried: "VACUITY: an empty buffer is not zero rows" crates/batten/tests/it/review_answered.rs
// carried: "a buffer from a command nobody asked for never becomes the record" crates/batten/tests/it/review_answered.rs
// carried: "a re-draft is not a ready, even on a head carrying findings" crates/batten/tests/it/review_answered.rs
// carried: "a commit message naming the command is prose, not a ready" crates/batten/tests/it/review_answered.rs
// carried: "reading the review is never refused, so the remedy is reachable" crates/batten/tests/it/review_answered.rs
//!
