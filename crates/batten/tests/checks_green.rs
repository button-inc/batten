...
//
// carried: mise-tasks/checks-green.sh crates/batten/src/checks_green.rs kind:verb crates/batten/tests/checks_green.rs
// carried: tests/checks-green.bats crates/batten/src/checks_green.rs kind:verb crates/batten/tests/checks_green.rs
//
