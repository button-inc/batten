...
//!
// carried: "a create recorded with an unready verdict stops the lap, and the refusal names the id" crates/batten/tests/filed_here.rs
...
// carried: "superseding is per id: one row groomed leaves another's refusal standing" crates/batten/tests/filed_here.rs
...
// carried: "one unrefined row among refined ones is reported, and only that one" crates/batten/tests/filed_here.rs
// carried: "a branch that filed nothing passes untouched" crates/batten/tests/filed_here.rs
// carried: "an empty record passes" crates/batten/tests/filed_here.rs
// carried: "a record belonging to another branch is not read" crates/batten/tests/filed_here.rs
// carried: "a branch name with a slash finds its record, matching the recorder's spelling" crates/batten/tests/filed_here.rs
// carried: "the refusal carries the id and no prose from the row" crates/batten/tests/filed_here.rs
// carried: "a malformed line is skipped rather than judged" policy/filed-here.rego
// carried: "a row naming a file this branch is changing stops the lap" crates/batten/tests/filed_here.rs
...
// carried: "a four-field line predating the column is not refused" crates/batten/tests/filed_here.rs
// carried: "A ROW RECORDED BEFORE THIS BRANCH'S BASE IS NOT A PUNT OVER ITS DIFF" crates/batten/tests/filed_here.rs
// carried: "a row recorded after the base, whose §1 names the diff, still refuses" crates/batten/tests/filed_here.rs
...
// carried: "a six-field record with no §1 column is judged exactly as before" crates/batten/tests/filed_here.rs
// carried: "every overlapping path is named, one pointer per line" crates/batten/tests/filed_here.rs
...
// carried: "A ROW RECORDED BEFORE THE FILE WAS TOUCHED IS STILL CAUGHT" crates/batten/tests/filed_here.rs
// carried: "a recorded path the branch does not change is not reported" crates/batten/tests/filed_here.rs
// carried: "a row naming only files this branch leaves alone passes" policy/filed-here.rego
// carried: "A ROW THE PR CLOSES IS EXEMPT — filing then fixing is the point, not the punt" crates/batten/tests/filed_here.rs
// carried: "closing a different row does not exempt this one" crates/batten/tests/filed_here.rs
// carried: "the diff refusal carries the id and one path and nothing else" crates/batten/tests/filed_here.rs policy/filed-here.rego
//!
