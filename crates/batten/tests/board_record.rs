...
//!
// carried: "a created row is recorded with its id, updatedAt and a green verdict" crates/batten/tests/board_record.rs
// carried: "an unrefined row records a verdict of unready rather than being refused" crates/batten/tests/board_record.rs
// carried: "a row whose body names a changed file records a non-zero overlap" crates/batten/tests/board_record.rs
// carried: "A PATH NAMED ONLY OUTSIDE §1 IS IN THE NAMED COLUMN AND NOT THE §1 ONE" crates/batten/tests/board_record.rs
// carried: "a path named IN §1 reaches the §1 column, so a real claim is still visible" crates/batten/tests/board_record.rs
// carried: "a row naming nothing tracked records a zero" crates/batten/tests/board_record.rs
// carried: "updating an existing row is never recorded" crates/batten/tests/board_record.rs
// carried: "a groom of a row THIS branch filed is recorded" crates/batten/tests/board_record.rs
// carried: "a groom of a row this branch did NOT file is still skipped" crates/batten/tests/board_record.rs
// carried: "an id that merely PREFIXES a filed one does not count as filed here" crates/batten/tests/board_record.rs
// carried: "a groom whose §8 cites a blocker is unjudgeable, not unready" crates/batten/tests/board_record.rs
// carried: "a groom of a genuinely unready body still records unready" crates/batten/tests/board_record.rs
// carried: "a write records the rows its stored body cites" crates/batten/tests/board_record.rs
// carried: "a write passing exactly the rows it cites records zero" crates/batten/tests/board_record.rs
// carried: "zero and could-not-look are distinguishable in the record" crates/batten/tests/board_record.rs
// carried: "the row's own key is not counted as an edge to anywhere" crates/batten/tests/board_record.rs
// carried: "a write the producer never ran for records a dash, never a zero" crates/batten/tests/board_record.rs
// carried: "a comment records the issue key its input names, not the comment uuid" crates/batten/tests/board_record.rs
// carried: "REGRESSION: a comment row never records a uuid" crates/batten/tests/board_record.rs
// carried: "a reply, or a comment on a non-issue parent, records a dash rather than a guess" crates/batten/tests/board_record.rs
// carried: "all three live connector spellings are recorded identically" crates/batten/tests/board_record.rs
// carried: "a tool that does not write to the board is never recorded" crates/batten/tests/board_record.rs
// carried: "POINTER, NEVER PAYLOAD: no byte of the description reaches the record" crates/batten/tests/board_record.rs
// carried: "POINTER, NEVER PAYLOAD: the citing sentence does not reach the record" crates/batten/tests/board_record.rs
// carried: "a comment on a row does not make a later update to it recordable" crates/batten/tests/board_record.rs
// carried: "nothing from the body but a tracked path reaches the record" crates/batten/tests/board_record.rs
//!
