...
//
// carried: tests/privileged-lane.bats policy/privileged-lane.rego crates/batten/tests/privileged_lane.rs
...
// carried: "a bot lane selecting by branch prefix is denied" crates/batten/tests/privileged_lane.rs
#[test]
...
// carried: "the same lane testing the head origin is clean" crates/batten/tests/privileged_lane.rs
#[test]
...
// carried: "a scheduled writer that resolves no outside head is not a subject" crates/batten/tests/privileged_lane.rs
#[test]
...
// carried: "an outsider-reachable writer that resolves no outside head is not a subject" crates/batten/tests/privileged_lane.rs
#[test]
...
// carried: "a read-only lane is not a subject" crates/batten/tests/privileged_lane.rs
#[test]
