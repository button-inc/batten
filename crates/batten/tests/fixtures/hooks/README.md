...
than reconstructed: *"model memory of this space is badly stale … anything
re-derived without a fetch should be assumed wrong."* A fixture pins what was
...
| cursor      | `beforeShellExecution` | *(derived)* | *(top level)*| `conversation_id` |
